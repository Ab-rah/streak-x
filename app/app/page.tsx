    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100 relative selection:bg-emerald-500/30">
      ...
      {isModalOpen && selectedDayIndex !== null && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl w-full max-w-md shadow-2xl overflow-hidden transform transition-all relative flex flex-col max-h-[90vh]">
            ...
            <div className="px-6 py-5 flex justify-between items-center border-b border-zinc-800/80 flex-shrink-0">
              ...
              <button onClick={() => setIsModalOpen(false)} className="text-zinc-500 hover:text-white transition-colors bg-zinc-800/50 hover:bg-zinc-700 p-1.5 rounded-full z-10">
                <X size={20} />
              </button>
            </div>

            <form onSubmit={saveActivity} className="p-6 space-y-6 overflow-y-auto flex-1">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-zinc-950/40 p-4 border border-zinc-800/80 rounded-2xl">
                    <div className="flex justify-between items-center pl-1 mb-3">
                      ...
                      <div className="flex items-center bg-zinc-900 border border-zinc-800 rounded-xl px-1 py-1 shadow-inner">
                        <input
                           type="number"
                           value={activityForm.duration || ''}
                           onChange={(e) => setActivityForm({ ...activityForm, duration: e.target.value === '' ? 0 : parseInt(e.target.value) })}
                           className="text-2xl font-bold text-white bg-transparent w-16 text-center outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        />
                        <span className="text-xs text-zinc-500 pr-3">min</span>
                      </div>
                    </div>
                    <input
                      type="range"
                  ...
                  {activityForm.type === 'Workout' && (
                    <div className="bg-zinc-950/40 p-4 border border-zinc-800/80 rounded-2xl animate-fade-in relative overflow-hidden group">
                      ...
                      <div className="relative z-10 flex justify-between items-center pl-1 mb-3">
                        ...
                        <div className="flex items-center bg-orange-950/30 border border-orange-500/20 rounded-xl px-1 py-1 shadow-[0_0_15px_rgba(249,115,22,0.1)]">
                          <input
                             type="number"
                             value={activityForm.metricValue || ''}
                             onChange={(e) => setActivityForm({ ...activityForm, metricValue: e.target.value === '' ? 0 : parseInt(e.target.value) })}
                             className="text-2xl font-bold text-orange-400 bg-transparent w-20 text-center outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                          />
                          <span className="text-xs text-orange-500/70 pr-3">kcal</span>
                        </div>
                      </div>
                      <input
                        type="range"
                  ...
                  {activityForm.type === 'Workout' && activityForm.subType === 'Walking' && (
                    <div className="bg-zinc-950/40 p-4 border border-zinc-800/80 rounded-2xl animate-fade-in relative overflow-hidden group">
                      ...
                      <div className="relative z-10 flex justify-between items-center pl-1 mb-3">
                        ...
                        <div className="flex items-center bg-teal-950/30 border border-teal-500/20 rounded-xl px-1 py-1 shadow-[0_0_15px_rgba(20,184,166,0.1)]">
                          <input
                             type="number"
                             value={activityForm.steps || ''}
                             onChange={(e) => setActivityForm({ ...activityForm, steps: e.target.value === '' ? 0 : parseInt(e.target.value) })}
                             className="text-2xl font-bold text-teal-400 bg-transparent w-24 text-center outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                          />
                        </div>
                      </div>
                      <input
